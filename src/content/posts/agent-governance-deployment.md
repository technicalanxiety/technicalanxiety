...
description: "Microsoft gave you agent governance tools but no IaC support. Heres how to automate agent governance with PowerShell and Graph API until Bicep catches up."
